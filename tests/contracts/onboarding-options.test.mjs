...
test('onboarding language options preserve exact IDs, order, labels, and icons', () => {
  assert.deepEqual(LEARNER_LANGUAGE_OPTIONS, [
...
test('onboarding level options preserve exact IDs, order, and copy', () => {
  assert.deepEqual(LEARNER_LEVEL_OPTIONS, [
    ...
    { id: 'intermediate', label: 'Intermediate', detail: 'I can follow lessons and some native content.' },
...
test('onboarding style names retain exact translation-key mappings', () => {
  assert.deepEqual(ONBOARDING_CHANNEL_STYLE_KEYS, {
