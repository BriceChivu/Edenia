...
const CITY_LEVELS = [
  ...
  { threshold: 60, labelKey: 'city.level.8', label: 'Your floating town is getting lively!' },
  { threshold: 70, labelKey: 'city.level.9', label: 'More corners of the island are waking up!' },
  { threshold: 80, labelKey: 'city.level.10', label: 'Your study island keeps growing!' },
  { threshold: 90, labelKey: 'city.level.11', label: 'This is becoming a real little town!' },
  { threshold: 100, labelKey: 'city.level.12', label: 'Your floating town is thriving!' }
]
...
const I18N_EN = {
  ...
  'city.level.8': 'Your floating town is getting lively!',
  'city.level.9': 'More corners of the island are waking up!',
  'city.level.10': 'Your study island keeps growing!',
  'city.level.11': 'This is becoming a real little town!',
  'city.level.12': 'Your floating town is thriving!',
...
const I18N = {
  ...
  'zh-Hant': {
    ...
    'city.level.8': '你的浮空小鎮越來越熱鬧了！',
    'city.level.9': '小島的更多角落醒來了！',
    'city.level.10': '你的學習小島還在成長！',
    'city.level.11': '這裡快變成真正的小鎮了！',
    'city.level.12': '你的浮空小鎮正在繁榮！',
    'goal.title': '每週目標',
    'goal.watched': '已看',
    'goal.inProgress': '進行中',
    'goal.toGo': '還差',
  ...
  'zh-Hans': {
    ...
    'city.level.8': '你的浮空小镇越来越热闹了！',
    'city.level.9': '小岛的更多角落醒来了！',
    'city.level.10': '你的学习小岛还在成长！',
    'city.level.11': '这里快变成真正的小镇了！',
    'city.level.12': '你的浮空小镇正在繁荣！',
    'goal.title': '每周目标',
    'goal.watched': '已看',
    'goal.inProgress': '进行中',
    'goal.toGo': '还差',
  ...
  es: {
    ...
    'city.level.8': '¡Tu pueblo flotante está cobrando vida!',
    'city.level.9': '¡Más rincones de la isla están despertando!',
    'city.level.10': '¡Tu isla de estudio sigue creciendo!',
    'city.level.11': '¡Esto se está convirtiendo en un verdadero pueblito!',
    'city.level.12': '¡Tu pueblo flotante está prosperando!',
  ...
  fr: {
    ...
    'city.level.8': 'Votre ville flottante devient vivante !',
    'city.level.9': 'D’autres coins de l’île se réveillent !',
    'city.level.10': 'Votre île d’étude continue de grandir !',
    'city.level.11': 'Cela devient une vraie petite ville !',
    'city.level.12': 'Votre ville flottante prospère !',
