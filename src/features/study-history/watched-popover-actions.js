...
export function bindStudyHistoryWatchedPopoverActions(root, actions) {
  if (!root || typeof root.querySelectorAll !== 'function') {
    throw new TypeError(
      'Study History watched popover actions require a queryable root'
    )
  }
  if (
    !actions
    ...
    throw new TypeError(
      'Study History watched popover actions require open, closeSoon, and toggle callbacks'
    )
  }
