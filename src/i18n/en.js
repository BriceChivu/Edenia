export const EN_CORE = {
  ...
  'settings.videoActions.watchLaterLegacy': 'Watch later keeps a video in your active list for another time. Using it on a set-aside video makes that video active again.',
