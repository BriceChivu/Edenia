export const EN_CORE = {
  ...
  'onboarding.account.title': 'Sign in or create your account',
  'onboarding.account.subtitle': 'Use Google, or enter a six-digit code sent to your email.',
  'onboarding.account.signedInSubtitle': 'You’re signed in and ready to begin your Edenia journey.',
  'onboarding.account.skip': 'Skip for now',
  ...
  'progressSync.backupGuidance': 'Your study stays on this device. You can keep studying, try the backup again, or export a recovery copy.',
  'progressSync.retry': 'Try backup again',
  'progressSync.exportRecovery': 'Export recovery copy',
  ...
  'settings.account.signedOutTitle': 'Sign in or create your account',
  'settings.account.signedOutBody': 'Use Google, or request a six-digit code by email.',
  ...
  'settings.account.requestCode': 'Email me a code',
  'settings.account.requestingCode': 'Sending code…',
  'settings.account.codeLabel': 'Six-digit code',
  'settings.account.codePlaceholder': '123456',
  'settings.account.verifyCode': 'Verify code',
  'settings.account.verifyingCode': 'Verifying code…',
  'settings.account.securityCheckPending': 'Complete the security check to continue.',
  'settings.account.securityCheckExpired': 'The security check expired. Complete it again.',
  'settings.account.securityCheckUnavailable': 'Email sign-in is temporarily unavailable. You can still use Google.',
  ...
  'settings.account.signingOutEverywhere': 'Signing out everywhere…',
  ...
  'settings.account.feedback.captchaRequired': 'Complete the security check before requesting a code.',
  'settings.account.feedback.codeCooldown': 'Wait a minute before requesting another code.',
  'settings.account.feedback.codeExpired': 'That code expired. Request a new one and try again.',
  'settings.account.feedback.codeRequestError': 'Edenia could not send the code. Please try again.',
  'settings.account.feedback.codeVerificationError': 'That code could not be verified. Check it and try again.',
  'settings.account.feedback.rateLimited': 'Too many sign-in attempts. Wait a few minutes and try again.',
  'settings.account.feedback.invalidCode': 'Enter the six-digit code from your email.',
  'settings.account.feedback.offline': 'You appear to be offline. Reconnect and try again.',
  ...
  'settings.account.feedback.codeSent': 'Enter the six-digit code sent to your email.',
  ...
  'settings.anki.enabled': 'Enable Anki',
  ...
  'settings.sync.importWarningTitle': 'Replace this profile?',
  'settings.sync.importWarning': 'Import replaces this profile. Edenia does not merge progress automatically. It protects the current version first so a failed import can roll back.',
  'settings.sync.importFile': 'Selected file: {fileName}',
  'settings.sync.importCancel': 'Cancel',
  'settings.sync.importConfirm': 'Protect current progress and replace',
  ...
  'settings.legacyProgress.recover': 'Recover progress from the old Edenia address',
  'settings.legacyProgress.note': 'Use this if you studied on Edenia before it moved to edenia.study.',
  'profileAccess.resolving.title': 'Opening your progress…',
  'profileAccess.resolving.body': 'Edenia is verifying which learner profile can safely open.',
  'profileAccess.locked.title': 'Welcome back — sign in to continue your town.',
  'profileAccess.locked.body': 'Sign in with the verified owner to continue this town.',
  'profileAccess.authentication.title': 'Sign in to unlock your profile',
  'profileAccess.authentication.body': 'Use the account that owns this learner profile.',
  'profileAccess.authentication.back': 'Back to locked message',
  'profileAccess.authentication.status': 'Your learner profile stays hidden until ownership checks succeed.',
  'profileAccess.waitingAuthentication.title': 'Sign in to continue',
  ...
  'profileAccess.conflicting.body': 'Edenia kept both versions protected and will not choose or overwrite either one automatically.',
  'profileConflict.comparisonTitle': 'Compare your profiles',
  'profileConflict.neutralNote': 'Review the differences and choose the version you recognize. Edenia does not recommend a version because it is newer.',
  'profileConflict.difference': 'Difference',
  'profileConflict.thisDevice': 'This device',
  'profileConflict.cloud': 'Cloud',
  'profileConflict.noMeaningfulDifferences': 'These versions have no meaningful differences in the compared study details.',
  'profileConflict.exportDevice': 'Export This device',
  'profileConflict.exportCloud': 'Export Cloud',
  'profileConflict.exportBoth': 'Export both',
  'profileConflict.chooseDevice': 'Use This device',
  'profileConflict.chooseCloud': 'Use Cloud',
  'profileConflict.confirm': 'Confirm this choice',
  'profileConflict.cancel': 'Cancel',
  'profileConflict.confirmDevice': 'Use This device? Edenia will protect Cloud for at least 30 days before activating your choice.',
  'profileConflict.confirmCloud': 'Use Cloud? Edenia will protect This device for at least 30 days before activating your choice.',
  'profileConflict.savingChoice': 'Protecting both versions and checking your choice…',
  'profileConflict.protectedTitle': 'Your protected profile versions',
  'profileConflict.protectedBody': 'The unchosen version is protected until {date} and can be downloaded now.',
  'profileConflict.protectedAvailableToast': 'Protected version is available until {date}.',
  'profileConflict.protectedDownloadStarted': 'Protected version download started.',
  'profileConflict.viewInSettings': 'View in Settings',
  'profileConflict.downloadProtectedDevice': 'Download protected This device',
  'profileConflict.downloadProtectedCloud': 'Download protected Cloud',
  'profileConflict.choiceFailed': 'Edenia could not verify and activate that choice. Both versions remain protected.',
  'profileConflict.exportFailed': 'Edenia could not export that protected version.',
  ...
  'profileConflict.category.channels': 'Channels',
  'profileConflict.value.none': 'None',
  'profileConflict.value.updateStudy': 'Updated {updated}; {minutes} min across {days} study days',
  'profileConflict.value.languageLevel': '{languages}; {level}',
  'profileConflict.value.townStudy': 'Town level {level}; {facts} study facts; {watched} videos watched',
  'profileConflict.value.activityItem': '{title}, {time}',
  'profileConflict.value.videos': '{retained} saved; {watched} watched; {partial} in progress; {watchLater} watch later; {favorite} favorites; {removed} removed',
  'profileConflict.value.anki': '{reviewed} reviewed; {created} new; {days} study days',
  'profileConflict.value.channels': '{channels}; {selected} starter channels selected',
  'profileAccess.recovering.title': 'We need to check your progress',
  'profileAccess.recovering.body': 'Edenia could not open your progress yet. Your saved copies are safe. Try again or sign out.',
  'profileAccess.recovering.continue': 'Try again',
  'profileAccess.missingHead.title': 'Choose a recovery copy',
  'profileAccess.missingHead.body': 'Edenia found earlier progress but no current cloud progress snapshot. Restore or export one of the trusted copies below.',
  'profileAccess.unusableHead.title': 'Choose a recovery copy',
  'profileAccess.unusableHead.body': 'Edenia could not safely read the current cloud progress snapshot. Restore or export one of the trusted copies below.',
  'profileAccess.recovery.title': 'Available recovery copies',
  'profileAccess.recovery.local': 'This device has a learner profile verified for the signed-in account.',
  'profileAccess.recovery.protected': 'A protected cloud progress snapshot is available until {date}.',
  'profileAccess.recovery.restore': 'Restore this copy',
  'profileAccess.recovery.export': 'Export this copy',
  'profileAccess.recovery.none': 'No trusted recovery copy is available yet. Try again or sign out.',
  'profileAccess.recovery.restoreFailed': 'Edenia could not restore that copy. Nothing was replaced, and the recovery copies remain available.',
  'profileAccess.accountChange.synchronized.title': 'Protect progress before changing accounts',
  'profileAccess.accountChange.synchronized.body': 'The previous learner’s progress is synchronized. Continue to replace this browser’s locked copy with the signed-in account.',
  'profileAccess.accountChange.pending.title': 'Protect progress before changing accounts',
  'profileAccess.accountChange.pending.body': 'This browser has progress that has not synchronized. Sign out and return as the previous learner to sync it, or export or explicitly discard it before continuing.',
  'profileAccess.accountChange.blocked.title': 'Protect progress before changing accounts',
  'profileAccess.accountChange.blocked.body': 'Edenia cannot verify that this browser’s progress is synchronized. Export it or explicitly discard it before continuing.',
  'profileAccess.accountChange.continue': 'Continue with this account',
  'profileAccess.accountChange.export': 'Export progress and continue',
  'profileAccess.accountChange.discard': 'Discard progress and continue',
  'profileAccess.accountChange.discardConfirm': 'Discard this browser’s previous progress? It has not been synchronized or exported, and this action cannot be undone.',
  'profileAccess.replacing.title': 'Changing accounts safely…',
  'profileAccess.replacing.body': 'Edenia is protecting the previous copy before replacing it on this browser.',
  'profileAccess.reloading.title': 'Finishing the account change…',
  'profileAccess.reloading.body': 'Edenia will reopen with the signed-in learner profile.',
  'profileAccess.noProfileVisible': 'Learner profile hidden · autosave paused',
  'accountlessProfileMigration.notice.title': 'Keep your town safe across devices',
  'accountlessProfileMigration.notice.body': 'Back up this town to your Edenia account so your progress is protected and can follow you to another device.',
  'accountlessProfileMigration.notice.status': 'You have {days} days before sign-in is required.',
  'accountlessProfileMigration.countdown.title': 'Sign-in required in {days} days',
  'accountlessProfileMigration.countdown.titleSingular': 'Sign-in required in 1 day',
  'accountlessProfileMigration.countdown.titleNow': 'Sign-in required now',
  'accountlessProfileMigration.countdown.body': 'Back up this town now to protect your progress and use it across devices.',
  'accountlessProfileMigration.countdown.status': 'Your town remains available on this browser during the grace period.',
  'accountlessProfileMigration.finalGate.title': 'Welcome back — your town is still here.',
  'accountlessProfileMigration.finalGate.body': 'Sign in to protect this town before Edenia opens it for study.',
  'accountlessProfileMigration.finalGate.status': 'Your browser copy remains unchanged until authentication and profile ownership checks succeed.',
  'accountlessProfileMigration.authentication.title': 'Sign in or create your account',
  'accountlessProfileMigration.authentication.body': 'Sign in to attach this town only after Edenia verifies that the account has no cloud progress.',
  'accountlessProfileMigration.authentication.status': 'Your browser copy remains unchanged until backup succeeds.',
  'accountlessProfileMigration.confirmation.title': 'Continue as {email}?',
  'accountlessProfileMigration.confirmation.body': 'Confirm this email before Edenia checks whether the account can safely receive this town.',
  'accountlessProfileMigration.confirmation.status': 'Nothing has been attached or uploaded yet.',
  'accountlessProfileMigration.attaching.title': 'Backing up your town…',
  'accountlessProfileMigration.attaching.body': 'Edenia is verifying the account and accepting the first protected cloud revision.',
  'accountlessProfileMigration.attaching.status': 'Keep this page open. Your original browser copy is still protected.',
  'accountlessProfileMigration.backupFailed.title': 'Not backed up yet',
  'accountlessProfileMigration.backupFailed.body': 'You can keep studying on this device. Your original town is protected here, but it will not be available on another device until backup succeeds.',
  'accountlessProfileMigration.backupFailed.status': 'No accountless browser copy was removed.',
  'accountlessProfileMigration.signedInProfilePresent.title': 'This signed-in profile already has progress',
  'accountlessProfileMigration.signedInProfilePresent.body': 'Edenia did not attach or replace either town. You can try another sign-in without saved progress or come back later.',
  'accountlessProfileMigration.signedInProfilePresent.status': 'This browser town remains unchanged.',
  'accountlessProfileMigration.action.backup': 'Back up my progress now',
  'accountlessProfileMigration.action.confirm': 'Continue as this email',
  'accountlessProfileMigration.action.openSignIn': 'Open sign-in',
  'accountlessProfileMigration.action.retry': 'Try backup again',
  'accountlessProfileMigration.action.later': 'Later',
  'migration.disclosure.title': 'Checking for progress from your old Edenia address',
  'migration.disclosure.body': 'Edenia will briefly visit the old address in this browser and securely bring back any progress it finds. Your old copy will not be changed.',
  'migration.disclosure.status': 'The secure check will begin shortly.',
  'migration.working.title': 'Restoring your Edenia progress',
  'migration.working.body': 'Edenia is verifying the encrypted transfer and protecting a local recovery copy before it updates this browser.',
  'migration.working.status': 'Keep this page open for a moment…',
  'migration.failure.title': 'Your old progress was not changed',
  'migration.failure.body': 'Edenia could not safely finish the progress check. Try again, import a sync file, or continue without deciding that no old progress exists.',
  'migration.failure.status': 'No existing progress was overwritten.',
  'migration.action.retry': 'Try again',
  'migration.action.manual': 'Import sync file',
  'migration.action.continue': 'Continue without checking old progress',
  'migration.action.cancel': 'Cancel',
  'migration.notice.pending': 'Your progress is safely restored. Edenia will retry the final relay cleanup later.',
  'migration.notice.conflict': 'This browser already had different progress, so the old progress was saved as a local backup without replacing anything.',
  'migration.notice.recovered': 'Your progress from the old Edenia address was restored.',
  'migration.notice.alreadyPresent': 'This browser already had the same progress. A verified recovery backup is available in Settings.',
  ...
  'settings.startOver.open': 'Start over',
  'settings.startOver.warning': 'Start over with a blank profile? Your languages, channels, study history, streak, town, and saved settings will reset across devices. This does not delete your Edenia account or sign you out. You can undo for 30 days.',
  'settings.startOver.cancel': 'Cancel',
  'settings.startOver.confirm': 'Start over',
  'settings.startOver.undoTitle': 'Started over',
  'settings.startOver.undoAvailableUntil': 'Your previous progress is protected until {date}.',
  'settings.startOver.undo': 'Undo Start over',
  ...
  'backups.reason.legacyRecovery': 'Recovered from the old Edenia address',
  'backups.reason.legacyConflict': 'Old Edenia progress kept as a conflict backup',
  ...
  'toast.importOwnerRequired': 'Import is available after your signed-in profile finishes loading.',
  'toast.importProtectionRequired': 'Edenia could not protect your current progress. Nothing changed. Try again or export your current progress.',
  'toast.importStaleRevision': 'Your cloud progress changed before import. Nothing was replaced. Try again or export your current progress.',
  'toast.importRolledBack': 'Import could not finish, so Edenia restored your current progress. Try again or export it.',
  ...
  'log.legacyProgress.title': 'Old Edenia progress restored',
  'log.legacyProgress.detail': 'Securely recovered from the previous Edenia address.',
