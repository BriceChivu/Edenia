export const EN_CORE = {
  ...
  'onboarding.account.title': 'One last step',
  'onboarding.account.subtitle': 'Sign up for a more personalized Edenia experience. It’s free!',
  ...
  'settings.account.feedback.captchaRequired': 'Complete the security check before requesting a link.',
  'settings.account.feedback.magicLinkCooldown': 'Wait a minute before requesting another sign-in link.',
