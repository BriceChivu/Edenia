export const EN_CORE = {
  ...
  'settings.videoActions.more': 'More actions lets you remove a video from Continue Watching or from your feed without erasing recorded study activity. Removed videos can be returned to the feed below Watched.',
  ...
  'videos.actions.removeContinue': 'Remove from Continue Watching',
