...
export const ES_LOCALIZED = {
    ...
    'settings.videoActions.watchLaterLegacy': 'Ver más tarde mantiene un video en tu lista activa para otro momento. Al usarlo en un video apartado, el video vuelve a estar activo.',
