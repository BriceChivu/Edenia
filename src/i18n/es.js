...
export const ES_LOCALIZED = {
    ...
    'settings.videoActions.more': 'Más acciones te permite quitar un video de Continuar viendo o de tu feed sin borrar la actividad de estudio registrada. Los videos quitados se pueden devolver al feed debajo de Vistos.',
  ...
  'settings.scoring.exampleAnki': 'Hacer 30 repasos de Anki da 10 pts, pero hacer 29 repasos da 9 pts (9.7 redondeado hacia abajo a 9).',
    ...
    'videos.actions.removeContinue': 'Quitar de Continuar viendo',
    ...
    'toast.videoRemovedFromContinue': 'Quitado de Continuar viendo',
    'toast.videoRemovedFromFeed': 'Quitado de tu feed',
    'toast.videoRestoredToFeed': 'Devuelto a tu feed',
    'toast.videoReturnedToFeed': 'Devuelto al feed como no visto',
