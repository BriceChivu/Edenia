...
export const ES_LOCALIZED = {
    ...
    'onboarding.account.title': 'Inicia sesión o crea tu cuenta',
    'onboarding.account.subtitle': 'Usa Google o introduce el código de seis dígitos que enviamos a tu correo.',
    'onboarding.account.signedInSubtitle': 'Has iniciado sesión y ya puedes comenzar tu aventura en Edenia.',
    'onboarding.account.skip': 'Omitir por ahora',
    ...
    'progressSync.waiting': 'Guardado en este dispositivo — esperando para sincronizar.',
    'progressSync.needsAttention': 'Requiere atención',
    'progressSync.notYetBackedUp': 'Aún no se ha creado la copia de seguridad',
    'progressSync.notBackedUp': 'Sin copia de seguridad',
    'progressSync.backupGuidance': 'Tu progreso sigue guardado en este dispositivo. Puedes seguir estudiando, volver a intentar la copia de seguridad o exportar una copia de recuperación.',
    'progressSync.retry': 'Volver a intentar la copia',
    'progressSync.exportRecovery': 'Exportar copia de recuperación',
    ...
    'settings.account.signedOutTitle': 'Inicia sesión o crea tu cuenta',
    'settings.account.signedOutBody': 'Usa Google o solicita un código de seis dígitos por correo.',
    ...
    'settings.account.requestCode': 'Enviarme un código',
    'settings.account.requestingCode': 'Enviando código…',
    'settings.account.codeLabel': 'Código de seis dígitos',
    'settings.account.codePlaceholder': '123456',
    'settings.account.verifyCode': 'Verificar código',
    'settings.account.verifyingCode': 'Verificando código…',
    'settings.account.securityCheckPending': 'Completa la comprobación de seguridad para continuar.',
    'settings.account.securityCheckExpired': 'La comprobación de seguridad caducó. Complétala de nuevo.',
    'settings.account.securityCheckUnavailable': 'El acceso por correo no está disponible temporalmente. Aún puedes usar Google.',
    ...
    'settings.account.signingOutEverywhere': 'Cerrando sesión en todas partes…',
    ...
    'settings.account.feedback.captchaRequired': 'Completa la comprobación de seguridad antes de solicitar un código.',
    'settings.account.feedback.codeCooldown': 'Espera un minuto antes de solicitar otro código.',
    'settings.account.feedback.codeExpired': 'Ese código ha caducado. Solicita uno nuevo e inténtalo otra vez.',
    'settings.account.feedback.codeRequestError': 'Edenia no pudo enviar el código. Inténtalo de nuevo.',
    'settings.account.feedback.codeVerificationError': 'No se pudo verificar ese código. Revísalo e inténtalo de nuevo.',
    'settings.account.feedback.rateLimited': 'Demasiados intentos de acceso. Espera unos minutos e inténtalo de nuevo.',
    'settings.account.feedback.invalidCode': 'Introduce el código de seis dígitos de tu correo.',
    'settings.account.feedback.offline': 'Parece que no tienes conexión. Vuelve a conectarte e inténtalo de nuevo.',
    ...
    'settings.account.feedback.codeSent': 'Introduce el código de seis dígitos enviado a tu correo.',
  ...
  'settings.scoring.exampleAnki': 'Hacer 30 repasos de Anki da 10 pts, pero hacer 29 repasos da 9 pts (9.7 redondeado hacia abajo a 9).',
    ...
    'settings.sync.importWarningTitle': '¿Reemplazar este perfil?',
    'settings.sync.importWarning': 'La importación reemplaza este perfil. Edenia no combina el progreso automáticamente. Primero protege la versión actual para poder restaurarla si falla la importación.',
    'settings.sync.importFile': 'Archivo seleccionado: {fileName}',
    'settings.sync.importCancel': 'Cancelar',
    'settings.sync.importConfirm': 'Proteger el progreso actual y reemplazar',
    ...
    'settings.legacyProgress.recover': 'Recuperar el progreso de la dirección antigua de Edenia',
    'settings.legacyProgress.note': 'Úsalo si estudiaste en Edenia antes de su traslado a edenia.study.',
    'profileAccess.resolving.title': 'Abriendo tu progreso…',
    'profileAccess.resolving.body': 'Edenia está verificando qué perfil de aprendizaje puede abrirse de forma segura.',
    'profileAccess.locked.title': 'Te damos la bienvenida — inicia sesión para continuar tu ciudad.',
    'profileAccess.locked.body': 'Inicia sesión con el propietario verificado para continuar esta ciudad.',
    'profileAccess.authentication.title': 'Inicia sesión para desbloquear tu perfil',
    'profileAccess.authentication.body': 'Usa la cuenta propietaria de este perfil de estudiante.',
    'profileAccess.authentication.back': 'Volver al mensaje de bloqueo',
    'profileAccess.authentication.status': 'Tu perfil de estudiante permanecerá oculto hasta que se verifique la propiedad.',
    'profileAccess.waitingAuthentication.title': 'Inicia sesión para continuar',
  ...
  'profileAccess.conflicting.body': 'Edenia protegió ambas versiones y no elegirá ni sobrescribirá ninguna automáticamente.',
  'profileConflict.comparisonTitle': 'Compara tus perfiles',
  'profileConflict.neutralNote': 'Revisa las diferencias y elige la versión que reconozcas. Edenia no recomienda una versión por ser más reciente.',
  'profileConflict.difference': 'Diferencia',
  'profileConflict.thisDevice': 'Este dispositivo',
  'profileConflict.cloud': 'Nube',
  'profileConflict.noMeaningfulDifferences': 'Estas versiones no tienen diferencias importantes en los datos de estudio comparados.',
  'profileConflict.exportDevice': 'Exportar Este dispositivo',
  'profileConflict.exportCloud': 'Exportar Nube',
  'profileConflict.exportBoth': 'Exportar ambas',
  'profileConflict.chooseDevice': 'Usar Este dispositivo',
  'profileConflict.chooseCloud': 'Usar Nube',
  'profileConflict.confirm': 'Confirmar esta elección',
  'profileConflict.cancel': 'Cancelar',
  'profileConflict.confirmDevice': '¿Usar Este dispositivo? Edenia protegerá Nube durante al menos 30 días antes de activar tu elección.',
  'profileConflict.confirmCloud': '¿Usar Nube? Edenia protegerá Este dispositivo durante al menos 30 días antes de activar tu elección.',
  'profileConflict.savingChoice': 'Protegiendo ambas versiones y comprobando tu elección…',
  'profileConflict.protectedTitle': 'Tus versiones de perfil protegidas',
  'profileConflict.protectedBody': 'La versión no elegida está protegida hasta el {date} y puede descargarse ahora.',
  'profileConflict.protectedAvailableToast': 'La versión protegida está disponible hasta el {date}.',
  'profileConflict.protectedDownloadStarted': 'Se inició la descarga de la versión protegida.',
  'profileConflict.viewInSettings': 'Ver en Ajustes',
  'profileConflict.downloadProtectedDevice': 'Descargar Este dispositivo protegido',
  'profileConflict.downloadProtectedCloud': 'Descargar Nube protegida',
  'profileConflict.choiceFailed': 'Edenia no pudo verificar y activar esa elección. Ambas versiones siguen protegidas.',
  'profileConflict.exportFailed': 'Edenia no pudo exportar esa versión protegida.',
  ...
  'profileConflict.category.channels': 'Canales',
  'profileConflict.value.none': 'Ninguno',
  'profileConflict.value.updateStudy': 'Actualizado {updated}; {minutes} min en {days} días de estudio',
  'profileConflict.value.languageLevel': '{languages}; {level}',
  'profileConflict.value.townStudy': 'Ciudad nivel {level}; {facts} datos de estudio; {watched} vídeos vistos',
  'profileConflict.value.activityItem': '{title}, {time}',
  'profileConflict.value.videos': '{retained} guardados; {watched} vistos; {partial} en curso; {watchLater} para después; {favorite} favoritos; {removed} retirados',
  'profileConflict.value.anki': '{reviewed} repasadas; {created} nuevas; {days} días de estudio',
  'profileConflict.value.channels': '{channels}; {selected} canales iniciales seleccionados',
  'profileAccess.recovering.title': 'Necesitamos comprobar tu progreso',
  'profileAccess.recovering.body': 'Edenia aún no pudo abrir tu progreso. Tus copias guardadas están seguras. Inténtalo de nuevo o cierra sesión.',
  'profileAccess.recovering.continue': 'Intentar de nuevo',
    'profileAccess.missingHead.title': 'Elige una copia de recuperación',
    'profileAccess.missingHead.body': 'Edenia encontró progreso anterior, pero no una instantánea actual del progreso en la nube. Restaura o exporta una de las copias de confianza.',
    'profileAccess.unusableHead.title': 'Elige una copia de recuperación',
    'profileAccess.unusableHead.body': 'Edenia no pudo leer de forma segura la instantánea actual del progreso en la nube. Restaura o exporta una de las copias de confianza.',
    'profileAccess.recovery.title': 'Copias de recuperación disponibles',
    'profileAccess.recovery.local': 'Este dispositivo tiene un perfil de aprendizaje verificado para la cuenta con sesión iniciada.',
    'profileAccess.recovery.protected': 'Hay una instantánea protegida del progreso en la nube disponible hasta el {date}.',
    'profileAccess.recovery.restore': 'Restaurar esta copia',
    'profileAccess.recovery.export': 'Exportar esta copia',
    'profileAccess.recovery.none': 'Aún no hay una copia de recuperación de confianza. Inténtalo de nuevo o cierra sesión.',
    'profileAccess.recovery.restoreFailed': 'Edenia no pudo restaurar esa copia. No se reemplazó nada y las copias de recuperación siguen disponibles.',
    'profileAccess.accountChange.synchronized.title': 'Protege el progreso antes de cambiar de cuenta',
    'profileAccess.accountChange.synchronized.body': 'El progreso de la persona anterior está sincronizado. Continúa para reemplazar su copia bloqueada en este navegador con la cuenta que inició sesión.',
    'profileAccess.accountChange.pending.title': 'Protege el progreso antes de cambiar de cuenta',
    'profileAccess.accountChange.pending.body': 'Este navegador tiene progreso sin sincronizar. Cierra sesión y vuelve como la persona anterior para sincronizarlo, o expórtalo o descártalo explícitamente antes de continuar.',
    'profileAccess.accountChange.blocked.title': 'Protege el progreso antes de cambiar de cuenta',
    'profileAccess.accountChange.blocked.body': 'Edenia no puede verificar que el progreso de este navegador esté sincronizado. Expórtalo o descártalo explícitamente antes de continuar.',
    'profileAccess.accountChange.continue': 'Continuar con esta cuenta',
    'profileAccess.accountChange.export': 'Exportar el progreso y continuar',
    'profileAccess.accountChange.discard': 'Descartar el progreso y continuar',
    'profileAccess.accountChange.discardConfirm': '¿Descartar el progreso anterior de este navegador? No se ha sincronizado ni exportado, y esta acción no se puede deshacer.',
    'profileAccess.replacing.title': 'Cambiando de cuenta de forma segura…',
    'profileAccess.replacing.body': 'Edenia está protegiendo la copia anterior antes de reemplazarla en este navegador.',
    'profileAccess.reloading.title': 'Terminando el cambio de cuenta…',
    'profileAccess.reloading.body': 'Edenia volverá a abrirse con el perfil de la persona que inició sesión.',
    'profileAccess.noProfileVisible': 'Perfil de aprendizaje oculto · guardado automático en pausa',
    'accountlessProfileMigration.notice.title': 'Protege tu ciudad en todos tus dispositivos',
    'accountlessProfileMigration.notice.body': 'Guarda esta ciudad en tu cuenta de Edenia para proteger tu progreso y llevarlo a otro dispositivo.',
    'accountlessProfileMigration.notice.status': 'Quedan {days} días para que sea obligatorio iniciar sesión.',
    'accountlessProfileMigration.countdown.title': 'Inicio de sesión obligatorio en {days} días',
    'accountlessProfileMigration.countdown.titleSingular': 'Inicio de sesión obligatorio en 1 día',
    'accountlessProfileMigration.countdown.titleNow': 'Ya es obligatorio iniciar sesión',
    'accountlessProfileMigration.countdown.body': 'Guarda esta ciudad ahora para proteger tu progreso y usarlo en todos tus dispositivos.',
    'accountlessProfileMigration.countdown.status': 'Tu ciudad seguirá disponible en este navegador durante el período de gracia.',
    'accountlessProfileMigration.finalGate.title': 'Te damos la bienvenida de nuevo: tu ciudad sigue aquí.',
    'accountlessProfileMigration.finalGate.body': 'Inicia sesión para proteger esta ciudad antes de que Edenia la abra para estudiar.',
    'accountlessProfileMigration.finalGate.status': 'La copia de este navegador no cambiará hasta que la autenticación y la comprobación de propiedad terminen correctamente.',
    'accountlessProfileMigration.authentication.title': 'Inicia sesión o crea tu cuenta',
    'accountlessProfileMigration.authentication.body': 'Inicia sesión para vincular esta ciudad solo después de que Edenia confirme que la cuenta no tiene progreso en la nube.',
    'accountlessProfileMigration.authentication.status': 'La copia de este navegador no cambiará hasta que la copia de seguridad termine correctamente.',
    'accountlessProfileMigration.confirmation.title': '¿Continuar como {email}?',
    'accountlessProfileMigration.confirmation.body': 'Confirma este correo antes de que Edenia compruebe si la cuenta puede recibir esta ciudad de forma segura.',
    'accountlessProfileMigration.confirmation.status': 'Todavía no se ha vinculado ni subido nada.',
    'accountlessProfileMigration.attaching.title': 'Guardando tu ciudad…',
    'accountlessProfileMigration.attaching.body': 'Edenia está verificando la cuenta y aceptando la primera revisión protegida en la nube.',
    'accountlessProfileMigration.attaching.status': 'Mantén esta página abierta. La copia original del navegador sigue protegida.',
    'accountlessProfileMigration.backupFailed.title': 'Todavía no se ha guardado',
    'accountlessProfileMigration.backupFailed.body': 'Puedes seguir estudiando en este dispositivo. Tu ciudad original está protegida aquí, pero no estará disponible en otro dispositivo hasta que la copia termine correctamente.',
    'accountlessProfileMigration.backupFailed.status': 'No se eliminó ninguna copia antigua del navegador.',
    'accountlessProfileMigration.signedInProfilePresent.title': 'Este perfil con sesión iniciada ya tiene progreso',
    'accountlessProfileMigration.signedInProfilePresent.body': 'Edenia no vinculó ni reemplazó ninguna ciudad. Puedes probar con otro inicio de sesión sin progreso guardado o volver más tarde.',
    'accountlessProfileMigration.signedInProfilePresent.status': 'La ciudad de este navegador no ha cambiado.',
    'accountlessProfileMigration.action.backup': 'Guardar mi progreso ahora',
    'accountlessProfileMigration.action.confirm': 'Continuar con este correo',
    'accountlessProfileMigration.action.openSignIn': 'Abrir inicio de sesión',
    'accountlessProfileMigration.action.retry': 'Volver a intentar la copia',
    'accountlessProfileMigration.action.later': 'Más tarde',
    'migration.disclosure.title': 'Buscando progreso en tu antigua dirección de Edenia',
    'migration.disclosure.body': 'Edenia visitará brevemente la dirección antigua en este navegador y traerá de forma segura el progreso que encuentre. La copia antigua no cambiará.',
    'migration.disclosure.status': 'La comprobación segura comenzará en breve.',
    'migration.working.title': 'Restaurando tu progreso de Edenia',
    'migration.working.body': 'Edenia está verificando la transferencia cifrada y protegiendo una copia local de recuperación antes de actualizar este navegador.',
    'migration.working.status': 'Mantén esta página abierta un momento…',
    'migration.failure.title': 'Tu progreso antiguo no cambió',
    'migration.failure.body': 'Edenia no pudo terminar la comprobación de forma segura. Inténtalo de nuevo, importa un archivo de sincronización o continúa sin concluir que no existe progreso antiguo.',
    'migration.failure.status': 'No se sobrescribió ningún progreso existente.',
    'migration.action.retry': 'Intentar de nuevo',
    'migration.action.manual': 'Importar archivo de sincronización',
    'migration.action.continue': 'Continuar sin comprobar el progreso antiguo',
    'migration.action.cancel': 'Cancelar',
    'migration.notice.pending': 'Tu progreso está restaurado de forma segura. Edenia volverá a intentar la limpieza final del relé más tarde.',
    'migration.notice.conflict': 'Este navegador ya tenía un progreso diferente, así que el progreso antiguo se guardó como copia local sin reemplazar nada.',
    'migration.notice.recovered': 'Se restauró tu progreso de la antigua dirección de Edenia.',
    'migration.notice.alreadyPresent': 'Este navegador ya tenía el mismo progreso. Hay una copia de recuperación verificada en Ajustes.',
    ...
    'settings.startOver.open': 'Empezar de nuevo',
    'settings.startOver.warning': '¿Quieres empezar de nuevo con un perfil vacío? Tus idiomas, canales, historial de estudio, racha, pueblo y ajustes se restablecerán en todos tus dispositivos. Esto no elimina tu cuenta de Edenia ni cierra tu sesión. Puedes deshacerlo durante 30 días.',
    'settings.startOver.cancel': 'Cancelar',
    'settings.startOver.confirm': 'Empezar de nuevo',
    'settings.startOver.undoTitle': 'Has empezado de nuevo',
    'settings.startOver.undoAvailableUntil': 'Tu progreso anterior está protegido hasta {date}.',
    'settings.startOver.undo': 'Deshacer Empezar de nuevo',
  ...
  'backups.reason.legacyRecovery': 'Recuperado de la antigua dirección de Edenia',
  'backups.reason.legacyConflict': 'Progreso antiguo de Edenia guardado por conflicto',
  ...
  'toast.importOwnerRequired': 'La importación estará disponible cuando termine de cargarse tu perfil con sesión iniciada.',
  'toast.importProtectionRequired': 'Edenia no pudo proteger tu progreso actual. No se cambió nada. Inténtalo de nuevo o exporta tu progreso actual.',
  'toast.importStaleRevision': 'Tu progreso en la nube cambió antes de la importación. No se reemplazó nada. Inténtalo de nuevo o exporta tu progreso actual.',
  'toast.importRolledBack': 'La importación no pudo finalizar, así que Edenia restauró tu progreso actual. Inténtalo de nuevo o expórtalo.',
  ...
  'log.legacyProgress.title': 'Progreso antiguo de Edenia restaurado',
  'log.legacyProgress.detail': 'Recuperado de forma segura desde la dirección anterior de Edenia.',
