...
export const ES_LOCALIZED = {
    ...
    'onboarding.account.title': 'Un último paso',
    'onboarding.account.subtitle': 'Regístrate para disfrutar de una experiencia de Edenia más personalizada. ¡Es gratis!',
    ...
    'settings.account.feedback.captchaRequired': 'Completa la comprobación de seguridad antes de solicitar un enlace.',
    'settings.account.feedback.magicLinkCooldown': 'Espera un minuto antes de solicitar otro enlace de acceso.',
