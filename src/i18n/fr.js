...
export const FR_LOCALIZED = {
    ...
    'settings.videoActions.watchLaterLegacy': 'À regarder plus tard garde une vidéo dans votre liste active. Utilisé sur une vidéo mise de côté, ce choix la rend de nouveau active.',
