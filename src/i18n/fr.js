...
export const FR_LOCALIZED = {
    ...
    'progressSync.waiting': 'Enregistré sur cet appareil — en attente de synchronisation.',
    'progressSync.needsAttention': 'Intervention requise',
    'progressSync.notYetBackedUp': 'Pas encore sauvegardé',
    'progressSync.notBackedUp': 'Non sauvegardé',
    'progressSync.backupGuidance': 'Votre progression reste sur cet appareil. Vous pouvez continuer à étudier, réessayer la sauvegarde ou exporter une copie de récupération.',
    'progressSync.retry': 'Réessayer la sauvegarde',
    'progressSync.exportRecovery': 'Exporter une copie de récupération',
    ...
    'settings.account.signOutEverywhere': 'Se déconnecter partout',
    'settings.account.signingOutEverywhere': 'Déconnexion partout…',
  ...
  'settings.scoring.exampleAnki': 'Faire 30 révisions Anki donne 10 pts, mais faire 29 révisions donne 9 pts (9,7 arrondi vers le bas à 9).',
    ...
    'settings.sync.importWarningTitle': 'Remplacer ce profil ?',
    'settings.sync.importWarning': 'L’importation remplace ce profil. Edenia ne fusionne pas automatiquement la progression. Edenia protège d’abord la version actuelle afin de pouvoir la restaurer si l’importation échoue.',
    'settings.sync.importFile': 'Fichier sélectionné : {fileName}',
    'settings.sync.importCancel': 'Annuler',
    'settings.sync.importConfirm': 'Protéger la progression actuelle et remplacer',
    ...
    'profileAccess.resolving.title': 'Ouverture de votre progression…',
    'profileAccess.resolving.body': 'Edenia vérifie quel profil d’apprentissage peut être ouvert en toute sécurité.',
    'profileAccess.locked.title': 'Bon retour — connectez-vous pour continuer votre ville.',
    'profileAccess.locked.body': 'Connectez-vous avec le propriétaire vérifié pour continuer cette ville.',
    'profileAccess.authentication.title': 'Connectez-vous pour déverrouiller votre profil',
    'profileAccess.authentication.body': 'Utilisez le compte propriétaire de ce profil d’apprentissage.',
    'profileAccess.authentication.back': 'Revenir au message de verrouillage',
    'profileAccess.authentication.status': 'Votre profil d’apprentissage reste masqué jusqu’à la vérification de son propriétaire.',
    ...
    'profileAccess.waitingCloud.title': 'Ouverture de votre progression…',
    'profileAccess.waitingCloud.body': 'Edenia vérifie le profil connecté avant de l’ouvrir sur cet appareil.',
    'profileAccess.opening.protected': 'Le contenu privé de l’apprenant reste masqué jusqu’à ce que le profil actif soit prêt.',
    'profileAccess.opening.status': 'Préparation de votre progression…',
  ...
  'profileConflict.comparisonTitle': 'Comparez vos profils',
  'profileConflict.neutralNote': 'Examinez les différences et choisissez la version que vous reconnaissez. Edenia ne recommande pas une version parce qu’elle est plus récente.',
  'profileConflict.difference': 'Différence',
  'profileConflict.thisDevice': 'Cet appareil',
  'profileConflict.cloud': 'Cloud',
  'profileConflict.noMeaningfulDifferences': 'Ces versions ne présentent aucune différence importante dans les informations d’étude comparées.',
  'profileConflict.exportDevice': 'Exporter Cet appareil',
  'profileConflict.exportCloud': 'Exporter Cloud',
  'profileConflict.exportBoth': 'Exporter les deux',
  'profileConflict.chooseDevice': 'Utiliser Cet appareil',
  'profileConflict.chooseCloud': 'Utiliser Cloud',
  'profileConflict.confirm': 'Confirmer ce choix',
  'profileConflict.cancel': 'Annuler',
  'profileConflict.confirmDevice': 'Utiliser Cet appareil ? Edenia protégera Cloud pendant au moins 30 jours avant d’activer votre choix.',
  'profileConflict.confirmCloud': 'Utiliser Cloud ? Edenia protégera Cet appareil pendant au moins 30 jours avant d’activer votre choix.',
  'profileConflict.savingChoice': 'Protection des deux versions et vérification de votre choix…',
  'profileConflict.protectedTitle': 'Vos versions de profil protégées',
  'profileConflict.protectedBody': 'La version non choisie est protégée jusqu’au {date} et peut être téléchargée maintenant.',
  'profileConflict.protectedAvailableToast': 'La version protégée est disponible jusqu’au {date}.',
  'profileConflict.protectedDownloadStarted': 'Le téléchargement de la version protégée a commencé.',
  'profileConflict.viewInSettings': 'Voir dans les paramètres',
  'profileConflict.downloadProtectedDevice': 'Télécharger Cet appareil protégé',
  'profileConflict.downloadProtectedCloud': 'Télécharger Cloud protégé',
  'profileConflict.choiceFailed': 'Edenia n’a pas pu vérifier et activer ce choix. Les deux versions restent protégées.',
  'profileConflict.exportFailed': 'Edenia n’a pas pu exporter cette version protégée.',
  ...
  'profileConflict.category.channels': 'Chaînes',
  'profileConflict.value.none': 'Aucun',
  'profileConflict.value.updateStudy': 'Mis à jour {updated} ; {minutes} min sur {days} jours d’étude',
  'profileConflict.value.languageLevel': '{languages} ; {level}',
  'profileConflict.value.townStudy': 'Ville niveau {level} ; {facts} faits d’étude ; {watched} vidéos regardées',
  'profileConflict.value.activityItem': '{title}, {time}',
  'profileConflict.value.videos': '{retained} enregistrées ; {watched} regardées ; {partial} en cours ; {watchLater} à regarder ; {favorite} favorites ; {removed} retirées',
  'profileConflict.value.anki': '{reviewed} révisions ; {created} nouvelles ; {days} jours d’étude',
  'profileConflict.value.channels': '{channels} ; {selected} chaînes de départ sélectionnées',
  'profileAccess.recovering.title': 'Nous devons vérifier votre progression',
  'profileAccess.recovering.body': 'Edenia n’a pas encore pu ouvrir votre progression. Vos copies enregistrées sont en sécurité. Réessayez ou déconnectez-vous.',
  'profileAccess.recovering.continue': 'Réessayer',
    'profileAccess.missingHead.title': 'Choisissez une copie de récupération',
    'profileAccess.missingHead.body': 'Edenia a trouvé une progression antérieure, mais aucun instantané actuel de la progression cloud. Restaurez ou exportez l’une des copies fiables ci-dessous.',
    'profileAccess.unusableHead.title': 'Choisissez une copie de récupération',
    'profileAccess.unusableHead.body': 'Edenia n’a pas pu lire en toute sécurité l’instantané actuel de la progression cloud. Restaurez ou exportez l’une des copies fiables ci-dessous.',
    'profileAccess.recovery.title': 'Copies de récupération disponibles',
    'profileAccess.recovery.local': 'Cet appareil contient un profil d’apprentissage vérifié pour le compte connecté.',
    'profileAccess.recovery.protected': 'Un instantané protégé de la progression cloud est disponible jusqu’au {date}.',
    'profileAccess.recovery.restore': 'Restaurer cette copie',
    'profileAccess.recovery.export': 'Exporter cette copie',
    'profileAccess.recovery.none': 'Aucune copie de récupération fiable n’est encore disponible. Réessayez ou déconnectez-vous.',
    'profileAccess.recovery.restoreFailed': 'Edenia n’a pas pu restaurer cette copie. Rien n’a été remplacé et les copies de récupération restent disponibles.',
    'profileAccess.accountChange.synchronized.title': 'Protégez la progression avant de changer de compte',
    'profileAccess.accountChange.synchronized.body': 'La progression de la personne précédente est synchronisée. Continuez pour remplacer sa copie verrouillée dans ce navigateur par le compte connecté.',
    'profileAccess.accountChange.pending.title': 'Protégez la progression avant de changer de compte',
    'profileAccess.accountChange.pending.body': 'Ce navigateur contient une progression non synchronisée. Déconnectez-vous et revenez avec le compte précédent pour la synchroniser, ou exportez-la ou supprimez-la explicitement avant de continuer.',
    'profileAccess.accountChange.blocked.title': 'Protégez la progression avant de changer de compte',
    'profileAccess.accountChange.blocked.body': 'Edenia ne peut pas vérifier que la progression de ce navigateur est synchronisée. Exportez-la ou supprimez-la explicitement avant de continuer.',
    'profileAccess.accountChange.continue': 'Continuer avec ce compte',
    'profileAccess.accountChange.export': 'Exporter la progression et continuer',
    'profileAccess.accountChange.discard': 'Supprimer la progression et continuer',
    'profileAccess.accountChange.discardConfirm': 'Supprimer la progression précédente de ce navigateur ? Elle n’a été ni synchronisée ni exportée, et cette action est irréversible.',
    'profileAccess.replacing.title': 'Changement de compte sécurisé…',
    'profileAccess.replacing.body': 'Edenia protège la copie précédente avant de la remplacer dans ce navigateur.',
    'profileAccess.reloading.title': 'Fin du changement de compte…',
    'profileAccess.reloading.body': 'Edenia va rouvrir le profil d’apprentissage du compte connecté.',
    'profileAccess.noProfileVisible': 'Profil d’apprentissage masqué · sauvegarde automatique en pause',
    'accountlessProfileMigration.notice.title': 'Protégez votre ville sur tous vos appareils',
    'accountlessProfileMigration.notice.body': 'Sauvegardez cette ville dans votre compte Edenia afin de protéger votre progression et de la retrouver sur un autre appareil.',
    'accountlessProfileMigration.notice.status': 'Il vous reste {days} jours avant que la connexion soit obligatoire.',
    'accountlessProfileMigration.countdown.title': 'Connexion obligatoire dans {days} jours',
    'accountlessProfileMigration.countdown.titleSingular': 'Connexion obligatoire dans 1 jour',
    'accountlessProfileMigration.countdown.titleNow': 'La connexion est maintenant obligatoire',
    'accountlessProfileMigration.countdown.body': 'Sauvegardez cette ville maintenant pour protéger votre progression et l’utiliser sur tous vos appareils.',
    'accountlessProfileMigration.countdown.status': 'Votre ville reste disponible dans ce navigateur pendant la période de grâce.',
    'accountlessProfileMigration.finalGate.title': 'Bon retour : votre ville est toujours là.',
    'accountlessProfileMigration.finalGate.body': 'Connectez-vous pour protéger cette ville avant qu’Edenia ne l’ouvre pour étudier.',
    'accountlessProfileMigration.finalGate.status': 'La copie de ce navigateur reste inchangée jusqu’à la réussite de l’authentification et de la vérification de propriété du profil.',
    'accountlessProfileMigration.authentication.title': 'Connectez-vous ou créez votre compte',
    'accountlessProfileMigration.authentication.body': 'Connectez-vous pour rattacher cette ville uniquement après qu’Edenia a vérifié que le compte ne contient aucune progression dans le cloud.',
    'accountlessProfileMigration.authentication.status': 'La copie de ce navigateur reste inchangée tant que la sauvegarde n’a pas réussi.',
    'accountlessProfileMigration.confirmation.title': 'Continuer avec {email} ?',
    'accountlessProfileMigration.confirmation.body': 'Confirmez cette adresse avant qu’Edenia vérifie si le compte peut recevoir cette ville en toute sécurité.',
    'accountlessProfileMigration.confirmation.status': 'Rien n’a encore été rattaché ni envoyé.',
    'accountlessProfileMigration.attaching.title': 'Sauvegarde de votre ville…',
    'accountlessProfileMigration.attaching.body': 'Edenia vérifie le compte et accepte la première révision protégée dans le cloud.',
    'accountlessProfileMigration.attaching.status': 'Gardez cette page ouverte. La copie d’origine de ce navigateur est toujours protégée.',
    'accountlessProfileMigration.backupFailed.title': 'Pas encore sauvegardée',
    'accountlessProfileMigration.backupFailed.body': 'Vous pouvez continuer à étudier sur cet appareil. Votre ville d’origine y est protégée, mais elle ne sera pas disponible sur un autre appareil tant que la sauvegarde n’aura pas réussi.',
    'accountlessProfileMigration.backupFailed.status': 'Aucune ancienne copie du navigateur n’a été supprimée.',
    'accountlessProfileMigration.signedInProfilePresent.title': 'Ce profil connecté contient déjà une progression',
    'accountlessProfileMigration.signedInProfilePresent.body': 'Edenia n’a rattaché ni remplacé aucune ville. Vous pouvez essayer une autre connexion sans progression enregistrée ou revenir plus tard.',
    'accountlessProfileMigration.signedInProfilePresent.status': 'La ville de ce navigateur reste inchangée.',
    'accountlessProfileMigration.action.backup': 'Sauvegarder ma progression',
    'accountlessProfileMigration.action.confirm': 'Continuer avec cette adresse',
    'accountlessProfileMigration.action.openSignIn': 'Ouvrir la connexion',
    'accountlessProfileMigration.action.retry': 'Réessayer la sauvegarde',
    'accountlessProfileMigration.action.later': 'Plus tard',
    ...
    'settings.startOver.open': 'Recommencer',
    'settings.startOver.warning': 'Recommencer avec un profil vide ? Vos langues, chaînes, historique d’étude, série, ville et réglages seront réinitialisés sur tous vos appareils. Cela ne supprime pas votre compte Edenia et ne vous déconnecte pas. Vous pouvez annuler pendant 30 jours.',
    'settings.startOver.cancel': 'Annuler',
    'settings.startOver.confirm': 'Recommencer',
    'settings.startOver.undoTitle': 'Nouveau départ effectué',
    'settings.startOver.undoAvailableUntil': 'Votre progression précédente est protégée jusqu’au {date}.',
    'settings.startOver.undo': 'Annuler le nouveau départ',
  ...
  'toast.importOwnerRequired': 'L’importation sera disponible une fois votre profil connecté chargé.',
  'toast.importProtectionRequired': 'Edenia n’a pas pu protéger votre progression actuelle. Rien n’a changé. Réessayez ou exportez votre progression actuelle.',
  'toast.importStaleRevision': 'Votre progression cloud a changé avant l’importation. Rien n’a été remplacé. Réessayez ou exportez votre progression actuelle.',
  'toast.importRolledBack': 'L’importation n’a pas pu aboutir. Edenia a donc restauré votre progression actuelle. Réessayez ou exportez-la.',
