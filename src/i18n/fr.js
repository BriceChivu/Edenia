...
export const FR_LOCALIZED = {
    ...
    'onboarding.account.title': 'Une dernière étape',
    'onboarding.account.subtitle': 'Inscrivez-vous pour profiter d’une expérience Edenia plus personnalisée. C’est gratuit !',
    ...
    'settings.account.signedOutTitle': 'Connectez-vous à Edenia',
    'settings.account.signedOutBody': 'Utilisez Google pour vous connecter rapidement ou recevez un lien sécurisé par e-mail.',
    ...
    'settings.account.sendLink': 'M’envoyer un lien de connexion',
    'settings.account.sendingLink': 'Envoi du lien…',
    ...
    'settings.account.feedback.captchaRequired': 'Effectuez la vérification de sécurité avant de demander un lien.',
    'settings.account.feedback.magicLinkCooldown': 'Attendez une minute avant de demander un autre lien de connexion.',
    ...
    'settings.account.feedback.linkSent': 'Consultez votre e-mail pour trouver le lien de connexion sécurisé.',
