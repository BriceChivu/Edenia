...
export const FR_LOCALIZED = {
    ...
    'settings.videoActions.more': 'Plus d’actions permet de retirer une vidéo de Continuer à regarder ou de votre fil sans effacer l’activité d’étude enregistrée. Les vidéos retirées peuvent être remises dans le fil sous Vues.',
  ...
  'settings.scoring.exampleAnki': 'Faire 30 révisions Anki donne 10 pts, mais faire 29 révisions donne 9 pts (9,7 arrondi vers le bas à 9).',
    ...
    'videos.actions.removeContinue': 'Retirer de Continuer à regarder',
