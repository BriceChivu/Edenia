...
export const ZH_HANT_LOCALIZED = {
    ...
    'onboarding.account.title': '登入或建立帳戶',
    'onboarding.account.subtitle': '使用 Google，或輸入傳送到你電子郵件的六位數驗證碼。',
    'onboarding.account.signedInSubtitle': '你已登入，可以開始 Edenia 學習旅程了。',
    'onboarding.account.skip': '暫時略過',
    ...
    'onboarding.starterFeed.progress': '正在準備你的入門影片動態…已完成 {current}/{total} 個頻道',
    'onboarding.starterFeed.ready': '你的入門影片動態已準備完成。',
    'onboarding.starterFeed.partial': '你的入門影片動態已準備完成，但有 {count} 個頻道無法載入。',
    'onboarding.starterFeed.failed': '無法準備你的入門影片動態。你可以稍後重新整理。',
    'onboarding.starterFeed.channelLimit': '已達可追蹤的頻道上限。',
    'onboarding.starterFeed.storageError': 'Edenia 無法儲存入門影片動態的進度。請重新整理後再試。',
    ...
    'progressSync.waiting': '已儲存在此裝置上 — 正在等待同步。',
    'progressSync.needsAttention': '需要處理',
    'progressSync.notYetBackedUp': '尚未備份',
    'progressSync.notBackedUp': '未備份',
    'progressSync.backupGuidance': '你的學習進度仍儲存在此裝置上。你可以繼續學習、重試備份，或匯出復原副本。',
    'progressSync.retry': '重試備份',
    'progressSync.exportRecovery': '匯出復原副本',
    'settings.account.title': '帳戶',
    'settings.account.description': '登入以準備使用未來的帳戶功能。',
    'settings.account.status.loading': '正在檢查你的帳戶…',
    'settings.account.signedOutTitle': '登入或建立帳戶',
    'settings.account.signedOutBody': '使用 Google，或透過電子郵件取得六位數驗證碼。',
    'settings.account.google': '使用 Google 繼續',
    'settings.account.googleLoading': '正在開啟 Google…',
    'settings.account.emailFallback': '或使用電子郵件',
    'settings.account.emailLabel': '電子郵件',
    'settings.account.emailPlaceholder': 'you@example.com',
    'settings.account.requestCode': '傳送驗證碼給我',
    'settings.account.requestingCode': '正在傳送驗證碼…',
    'settings.account.codeLabel': '六位數驗證碼',
    'settings.account.codePlaceholder': '123456',
    'settings.account.verifyCode': '驗證',
    'settings.account.verifyingCode': '正在驗證…',
    'settings.account.securityCheckPending': '請完成安全驗證以繼續。',
    'settings.account.securityCheckExpired': '安全驗證已過期，請重新完成。',
    'settings.account.securityCheckUnavailable': '電子郵件登入暫時無法使用，你仍可使用 Google。',
    'settings.account.signedInAs': '目前登入帳戶',
    'settings.account.signOut': '登出',
    'settings.account.signingOut': '正在登出…',
    'settings.account.signOutEverywhere': '在所有裝置上登出',
    'settings.account.signingOutEverywhere': '正在從所有裝置登出…',
    'settings.account.exportTitle': '帳戶資料',
    'settings.account.exportDescription': '下載 Edenia 儲存在伺服器上的帳戶與提醒資料。儲存在此瀏覽器中的學習進度不會包含在內。',
    'settings.account.exportDownload': '下載帳戶資料',
    'settings.account.exportDownloading': '正在準備下載…',
    'settings.account.exportFeedback.complete': '帳戶資料已下載。',
    'settings.account.exportFeedback.failed': 'Edenia 無法準備下載，請再試一次。',
    'settings.account.exportFeedback.rateLimited': '下載要求過多，請幾分鐘後再試。',
    'settings.account.exportFeedback.signInRequired': '請重新登入，再下載你的帳戶資料。',
    ...
    'settings.account.weekday.mon': '週一',
    'settings.account.weekday.tue': '週二',
    'settings.account.weekday.wed': '週三',
    'settings.account.weekday.thu': '週四',
    'settings.account.weekday.fri': '週五',
    'settings.account.weekday.sat': '週六',
    'settings.account.weekday.sun': '週日',
    'settings.account.remindersTime': '當地時間',
    'settings.account.remindersTimezone': 'IANA 時區',
    'settings.account.remindersTimezoneHelp': 'Edenia 會先使用你的裝置時區，你可以在儲存前修正。',
    'settings.account.remindersConsent': '我同意 Edenia 可依此時段使用電子郵件傳送學習提醒。',
    'settings.account.remindersSave': '儲存偏好設定',
    'settings.account.remindersSaving': '正在儲存…',
    'settings.account.remindersCancel': '放棄變更',
    'settings.account.remindersSignIn': '請先在上方登入，再啟用提醒。',
    'settings.account.remindersRetry': '重新載入',
    'settings.account.remindersNoDelivery': '此版本只會儲存偏好設定，沒有電子郵件寄送器或排程工作，因此無法傳送提醒。',
    'settings.account.remindersFeedback.loading': '正在載入你的提醒偏好設定…',
    'settings.account.remindersFeedback.invalidPreference': 'Edenia 無法讀取這項電子郵件偏好設定，請再試一次。',
    'settings.account.remindersFeedback.saved': '提醒偏好設定已儲存。沒有排程或傳送任何電子郵件。',
    'settings.account.remindersFeedback.loadError': 'Edenia 無法載入你的提醒偏好設定，請再試一次。',
    'settings.account.remindersFeedback.saveError': 'Edenia 無法儲存提醒偏好設定。先前儲存的設定沒有變更。',
    'settings.account.remindersFeedback.signInRequired': '請先登入，再啟用並儲存提醒。',
    'settings.account.remindersFeedback.invalidDays': '請至少選擇一個學習日。',
    'settings.account.remindersFeedback.invalidTime': '請選擇有效的當地時間。',
    'settings.account.remindersFeedback.invalidTimezone': '請輸入有效的 IANA 時區，例如 Asia/Taipei。',
    'settings.account.remindersFeedback.consentRequired': '啟用此偏好設定前，請同意接收提醒電子郵件。',
    'settings.account.localProgressNote': '你的學習進度會保留在此瀏覽器中，任何使用此瀏覽器設定檔的人都能看到。登入或登出不會上傳、取代進度，也不會將進度連結到帳戶。',
    'settings.account.feedback.googleError': '無法開始 Google 登入，請再試一次。',
    'settings.account.feedback.invalidEmail': '請輸入有效的電子郵件。',
    'settings.account.feedback.captchaRequired': '請先完成安全驗證，再要求驗證碼。',
    'settings.account.feedback.codeCooldown': '請等待一分鐘後再要求新的驗證碼。',
    'settings.account.feedback.codeExpired': '這組驗證碼已過期。請取得新的驗證碼後再試一次。',
    'settings.account.feedback.codeRequestError': 'Edenia 無法傳送驗證碼，請再試一次。',
    'settings.account.feedback.codeVerificationError': '無法驗證這組驗證碼。請檢查後再試一次。',
    'settings.account.feedback.rateLimited': '登入嘗試次數過多。請等待幾分鐘後再試一次。',
    'settings.account.feedback.invalidCode': '請輸入電子郵件中的六位數驗證碼。',
    'settings.account.feedback.offline': '你似乎處於離線狀態。請重新連線後再試一次。',
    'settings.account.feedback.cancelled': 'Google 登入已取消，沒有任何變更。',
    'settings.account.feedback.oauthError': '無法完成 Google 登入，請再試一次。',
    'settings.account.feedback.returnError': '無法從這個 Edenia 網址登入。',
    'settings.account.feedback.unavailable': '帳戶登入暫時無法使用，請稍後再試。',
    'settings.account.feedback.signOutError': 'Edenia 無法登出，請再試一次。',
    'settings.account.feedback.codeSent': '請輸入傳送到你電子郵件的六位數驗證碼。',
    ...
    'settings.anki.step2': '在 Add-ons 中，點 AnkiConnect，然後點 Config。複製：',
    'settings.anki.step2Paste': '並將它貼到 webCorsOriginList 的方括號清單中。例如，可以貼在以下內容之後：',
    'settings.anki.step2Result': '最後，設定應類似於：',
    'settings.anki.step2InsertCodeLabel': '要複製的 AnkiConnect 來源',
    'settings.anki.step2ExistingCodeLabel': 'AnkiConnect localhost 來源',
    'settings.anki.step2ExampleCodeLabel': 'AnkiConnect 設定範例',
  ...
  'settings.scoring.exampleAnki': '複習 30 張 Anki 卡會得到 10 分，但複習 29 張會得到 9 分（9.7 向下取整為 9）。',
    ...
    'settings.sync.importWarningTitle': '取代此學習檔案？',
    'settings.sync.importWarning': '匯入會取代此學習檔案。Edenia 不會自動合併進度。Edenia 會先保護目前版本，以便匯入失敗時自動復原。',
    'settings.sync.importFile': '已選擇檔案：{fileName}',
    'settings.sync.importCancel': '取消',
    'settings.sync.importConfirm': '保護目前進度並取代',
    'settings.sync.note': '進度會儲存在這個瀏覽器。使用同步檔可以把同一份進度帶到其他裝置或瀏覽器。',
    'settings.legacyProgress.recover': '從舊 Edenia 網址復原進度',
    'settings.legacyProgress.note': '如果你曾在 Edenia 搬到 edenia.study 前使用它，請使用此功能。',
    'profileAccess.resolving.title': '正在開啟你的學習進度…',
    'profileAccess.resolving.body': 'Edenia 正在驗證可以安全開啟哪個學習者檔案。',
    'profileAccess.locked.title': '歡迎回來 — 登入以繼續你的城鎮。',
    'profileAccess.locked.body': '請以已驗證的擁有者身分登入，繼續使用這座城鎮。',
    'profileAccess.authentication.title': '登入以解鎖你的學習檔案',
    'profileAccess.authentication.body': '請使用擁有此學習檔案的帳戶。',
    'profileAccess.authentication.back': '返回鎖定提示',
    'profileAccess.authentication.status': '在擁有權驗證成功前，你的學習檔案將保持隱藏。',
    'profileAccess.waitingAuthentication.title': '登入以繼續',
    ...
    'profileAccess.conflicting.body': 'Edenia 已保護兩個版本，不會自動選擇或覆寫其中任何一個。',
    'profileConflict.comparisonTitle': '比較你的檔案',
    'profileConflict.neutralNote': '查看差異並選擇你熟悉的版本。Edenia 不會只因某個版本更新較晚就推薦它。',
    'profileConflict.difference': '差異',
    'profileConflict.thisDevice': '此裝置',
    'profileConflict.cloud': '雲端',
    'profileConflict.noMeaningfulDifferences': '這些版本在所比較的學習資訊中沒有明顯差異。',
    'profileConflict.exportDevice': '匯出此裝置版本',
    'profileConflict.exportCloud': '匯出雲端版本',
    'profileConflict.exportBoth': '匯出兩個版本',
    'profileConflict.chooseDevice': '使用此裝置版本',
    'profileConflict.chooseCloud': '使用雲端版本',
    'profileConflict.confirm': '確認此選擇',
    'profileConflict.cancel': '取消',
    'profileConflict.confirmDevice': '使用此裝置版本？Edenia 會先將雲端版本保護至少 30 天，再啟用你的選擇。',
    'profileConflict.confirmCloud': '使用雲端版本？Edenia 會先將此裝置版本保護至少 30 天，再啟用你的選擇。',
    'profileConflict.savingChoice': '正在保護兩個版本並檢查你的選擇…',
    'profileConflict.protectedTitle': '受保護的個人資料版本',
    'profileConflict.protectedBody': '未選擇的版本將保護至 {date}，現在即可下載。',
    'profileConflict.protectedAvailableToast': '受保護的版本可下載至 {date}。',
    'profileConflict.protectedDownloadStarted': '已開始下載受保護的版本。',
    'profileConflict.viewInSettings': '在設定中查看',
    'profileConflict.downloadProtectedDevice': '下載受保護的此裝置版本',
    'profileConflict.downloadProtectedCloud': '下載受保護的雲端版本',
    'profileConflict.choiceFailed': 'Edenia 無法驗證並啟用該選擇。兩個版本仍受保護。',
    'profileConflict.exportFailed': 'Edenia 無法匯出該受保護版本。',
    ...
    'profileConflict.category.channels': '頻道',
    'profileConflict.value.none': '無',
    'profileConflict.value.updateStudy': '更新於 {updated}；在 {days} 個學習日中學習 {minutes} 分鐘',
    'profileConflict.value.languageLevel': '{languages}；{level}',
    'profileConflict.value.townStudy': '城鎮等級 {level}；{facts} 筆學習記錄；已觀看 {watched} 部影片',
    'profileConflict.value.activityItem': '{title}，{time}',
    'profileConflict.value.videos': '已儲存 {retained} 部；已觀看 {watched} 部；進行中 {partial} 部；稍後觀看 {watchLater} 部；收藏 {favorite} 部；已移除 {removed} 部',
    'profileConflict.value.anki': '複習 {reviewed} 張；新增 {created} 張；{days} 個學習日',
    'profileConflict.value.channels': '{channels}；已選擇 {selected} 個起始頻道',
  'profileAccess.recovering.title': '我們需要檢查你的學習進度',
    'profileAccess.recovering.body': 'Edenia 目前無法開啟你的學習進度。你儲存的副本是安全的。請重試或登出。',
    'profileAccess.recovering.continue': '重試',
    'profileAccess.missingHead.title': '選擇復原副本',
    'profileAccess.missingHead.body': 'Edenia 找到了以往進度，但沒有找到目前的雲端進度快照。請復原或匯出下方的可信副本。',
    'profileAccess.unusableHead.title': '選擇復原副本',
    'profileAccess.unusableHead.body': 'Edenia 無法安全讀取目前的雲端進度快照。請復原或匯出下方的可信副本。',
    'profileAccess.recovery.title': '可用的復原副本',
    'profileAccess.recovery.local': '此裝置中有一個已驗證屬於目前登入帳號的學習者檔案。',
    'profileAccess.recovery.protected': '有一個受保護的雲端進度快照可用至 {date}。',
    'profileAccess.recovery.restore': '復原此副本',
    'profileAccess.recovery.export': '匯出此副本',
    'profileAccess.recovery.none': '暫時沒有可信的復原副本。請再試一次或登出。',
    'profileAccess.recovery.restoreFailed': 'Edenia 無法復原該副本。沒有替換任何內容，復原副本仍可使用。',
    'profileAccess.accountChange.synchronized.title': '切換帳號前先保護進度',
    'profileAccess.accountChange.synchronized.body': '上一位學習者的進度已同步。繼續後，此瀏覽器中已鎖定的副本將替換為目前登入帳號的檔案。',
    'profileAccess.accountChange.pending.title': '切換帳號前先保護進度',
    'profileAccess.accountChange.pending.body': '此瀏覽器中有尚未同步的進度。請登出並以上一位學習者身分返回完成同步，或先匯出進度，或明確捨棄進度後再繼續。',
    'profileAccess.accountChange.blocked.title': '切換帳號前先保護進度',
    'profileAccess.accountChange.blocked.body': 'Edenia 無法確認此瀏覽器中的進度已同步。請先匯出進度，或明確捨棄進度後再繼續。',
    'profileAccess.accountChange.continue': '使用此帳號繼續',
    'profileAccess.accountChange.export': '匯出進度並繼續',
    'profileAccess.accountChange.discard': '捨棄進度並繼續',
    'profileAccess.accountChange.discardConfirm': '要捨棄此瀏覽器中上一份進度嗎？該進度尚未同步或匯出，而且此操作無法復原。',
    'profileAccess.replacing.title': '正在安全切換帳號…',
    'profileAccess.replacing.body': 'Edenia 正在保護上一份副本，然後才會在此瀏覽器中替換它。',
    'profileAccess.reloading.title': '正在完成帳號切換…',
    'profileAccess.reloading.body': 'Edenia 將使用目前登入的學習者檔案重新開啟。',
    'profileAccess.noProfileVisible': '學習者檔案已隱藏 · 自動儲存已暫停',
    'accountlessProfileMigration.notice.title': '在所有裝置上保護你的城鎮',
    'accountlessProfileMigration.notice.body': '將這座城鎮備份到你的 Edenia 帳號，以保護進度並在其他裝置上繼續使用。',
    'accountlessProfileMigration.notice.status': '還有 {days} 天必須登入。',
    'accountlessProfileMigration.countdown.title': '{days} 天後必須登入',
    'accountlessProfileMigration.countdown.titleSingular': '1 天後必須登入',
    'accountlessProfileMigration.countdown.titleNow': '現在必須登入',
    'accountlessProfileMigration.countdown.body': '立即備份這座城鎮，以保護進度並在所有裝置上使用。',
    'accountlessProfileMigration.countdown.status': '寬限期內，你仍可在此瀏覽器中使用這座城鎮。',
    'accountlessProfileMigration.finalGate.title': '歡迎回來，你的城鎮還在這裡。',
    'accountlessProfileMigration.finalGate.body': '請先登入並保護這座城鎮，Edenia 才會開放學習。',
    'accountlessProfileMigration.finalGate.status': '身分驗證和學習檔案擁有權檢查成功前，此瀏覽器中的副本不會改變。',
    'accountlessProfileMigration.authentication.title': '登入或建立帳號',
    'accountlessProfileMigration.authentication.body': '登入後，Edenia 只會在確認該帳號沒有雲端進度時連結這座城鎮。',
    'accountlessProfileMigration.authentication.status': '備份成功前，此瀏覽器中的副本不會改變。',
    'accountlessProfileMigration.confirmation.title': '以 {email} 繼續？',
    'accountlessProfileMigration.confirmation.body': '請先確認此電子郵件，Edenia 才會檢查該帳號能否安全接收這座城鎮。',
    'accountlessProfileMigration.confirmation.status': '尚未連結或上傳任何內容。',
    'accountlessProfileMigration.attaching.title': '正在備份你的城鎮…',
    'accountlessProfileMigration.attaching.body': 'Edenia 正在驗證帳號，並接受第一個受保護的雲端修訂版本。',
    'accountlessProfileMigration.attaching.status': '請保持此頁面開啟。瀏覽器中的原始副本仍受到保護。',
    'accountlessProfileMigration.backupFailed.title': '尚未備份',
    'accountlessProfileMigration.backupFailed.body': '你可以繼續在此裝置上學習。原始城鎮在這裡受到保護，但備份成功前無法在其他裝置上使用。',
    'accountlessProfileMigration.backupFailed.status': '未刪除任何舊瀏覽器副本。',
    'accountlessProfileMigration.signedInProfilePresent.title': '此已登入的學習檔案已有進度',
    'accountlessProfileMigration.signedInProfilePresent.body': 'Edenia 沒有連結或取代任何城鎮。你可以改用另一個沒有已儲存進度的登入帳號，或稍後再試。',
    'accountlessProfileMigration.signedInProfilePresent.status': '此瀏覽器中的城鎮未發生變化。',
    'accountlessProfileMigration.action.backup': '立即備份我的進度',
    'accountlessProfileMigration.action.confirm': '以此電子郵件繼續',
    'accountlessProfileMigration.action.openSignIn': '開啟登入',
    'accountlessProfileMigration.action.retry': '重新備份',
    'accountlessProfileMigration.action.later': '稍後',
    'migration.disclosure.title': '正在檢查舊 Edenia 網址中的進度',
    'migration.disclosure.body': 'Edenia 會在此瀏覽器短暫前往舊網址，並安全帶回找到的進度。舊副本不會被更改。',
    'migration.disclosure.status': '安全檢查即將開始。',
    'migration.working.title': '正在復原你的 Edenia 進度',
    'migration.working.body': 'Edenia 正在驗證加密傳輸，並先保護本機復原副本，再更新此瀏覽器。',
    'migration.working.status': '請讓此頁面保持開啟片刻…',
    'migration.failure.title': '你的舊進度沒有被更改',
    'migration.failure.body': 'Edenia 無法安全完成進度檢查。你可以重試、匯入同步檔，或繼續但不把結果視為「沒有舊進度」。',
    'migration.failure.status': '沒有覆寫任何既有進度。',
    'migration.action.retry': '再試一次',
    'migration.action.manual': '匯入同步檔',
    'migration.action.continue': '不檢查舊進度並繼續',
    'migration.action.cancel': '取消',
    'migration.notice.pending': '你的進度已安全復原。Edenia 稍後會再次嘗試完成中繼清理。',
    'migration.notice.conflict': '此瀏覽器已有不同進度，因此舊進度已存為本機備份，沒有取代任何內容。',
    'migration.notice.recovered': '已復原舊 Edenia 網址中的進度。',
    'migration.notice.alreadyPresent': '此瀏覽器已有相同進度。你可以在「設定」中找到已驗證的復原備份。',
    ...
    'settings.startOver.open': '重新開始',
    'settings.startOver.warning': '要使用空白學習檔案重新開始嗎？你的語言、頻道、學習紀錄、連續天數、小鎮進度和設定會在所有裝置上重設。這不會刪除你的 Edenia 帳戶，也不會將你登出。你可以在 30 天內復原。',
    'settings.startOver.cancel': '取消',
    'settings.startOver.confirm': '重新開始',
    'settings.startOver.undoTitle': '已重新開始',
    'settings.startOver.undoAvailableUntil': '你先前的進度會保護到 {date}。',
    'settings.startOver.undo': '復原重新開始',
    ...
    'toast.youtubeRequestTimeout': 'YouTube 請求逾時。',
    ...
    'guidance.extraDay.title': '試試{weekday}',
    'guidance.extraDay.body': '試著看 {minutes} 分鐘影片。',
    'guidance.extraDay.evidence': '最近完整的 {completeWeeks} 週中，你有 {successfulWeeks} 個{weekday}看了影片。一般學習日約為 {typicalTime}。',
    'guidance.week.above.title': '本週比平常多',
    'guidance.week.above.body': '下一次學習保持輕鬆就好。',
    'guidance.week.below.title': '試一次短學習',
    'guidance.week.below.body': '有空時試著學 {minutes} 分鐘。',
    'guidance.week.similar.title': '多加一次短學習',
    'guidance.week.similar.body': '如果想在本週多學一點，試著學 {minutes} 分鐘。',
    'guidance.week.evidence': '截至今天：{currentTime}。最近幾週通常是：{usualTime}。',
    'guidance.nextVideo': '選一部影片',
    'guidance.nextVideo.unavailable': '目前沒有可學習的影片。',
    ...
    'videos.channel.format.label': '{channel} 的影片類型',
    'videos.channel.format.videos': '影片',
    'videos.channel.format.shorts': '短影片',
    'videos.channel.format.emptyVideos': '這個檢視中沒有橫向影片。',
    'videos.channel.format.emptyShorts': '這個檢視中沒有直向影片。',
    ...
    'time.weekAgoCompact': '1 週前',
    'time.weeksAgoCompact': '{count} 週前',
    'time.monthsAgoCompact': '{count} 個月前',
    'time.hourShort': '小時',
  ...
  'backups.reason.legacyRecovery': '從舊 Edenia 網址復原',
  'backups.reason.legacyConflict': '舊 Edenia 進度衝突備份',
  ...
  'toast.importOwnerRequired': '登入後的學習檔案載入完成後才能匯入。',
  'toast.importProtectionRequired': 'Edenia 無法保護你目前的進度。沒有任何變更。請重試或匯出目前進度。',
  'toast.importStaleRevision': '匯入前雲端進度已變更。沒有取代任何內容。請重試或匯出目前進度。',
  'toast.importRolledBack': '匯入未能完成，Edenia 已復原你目前的進度。請重試或將其匯出。',
  ...
  'log.legacyProgress.title': '已復原舊 Edenia 進度',
  'log.legacyProgress.detail': '已從先前的 Edenia 網址安全復原。',
