...
export const ZH_HANT_LOCALIZED = {
  ...
  'settings.scoring.exampleAnki': '複習 30 張 Anki 卡會得到 10 分，但複習 29 張會得到 9 分（9.7 向下取整為 9）。',
    ...
    'profileAccess.resolving.title': '正在準備你的學習空間…',
    ...
    'profileAccess.waitingCloud.title': '正在檢查雲端進度…',
    ...
    'profileAccess.recovering.title': '正在保護你的進度…',
    'profileAccess.recovering.body': 'Edenia 已暫停檔案存取，同時驗證安全的復原方式。',
