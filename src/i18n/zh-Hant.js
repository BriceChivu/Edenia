...
export const ZH_HANT_LOCALIZED = {
    ...
    'onboarding.account.title': '最後一步',
    'onboarding.account.subtitle': '註冊即可獲得更個人化的 Edenia 體驗。完全免費！',
    ...
    'settings.account.signedOutTitle': '登入 Edenia',
    'settings.account.signedOutBody': '使用 Google 可快速登入，也可以透過電子郵件取得安全登入連結。',
    ...
    'settings.account.sendLink': '寄送登入連結給我',
    'settings.account.sendingLink': '正在傳送連結…',
    ...
    'settings.account.feedback.captchaRequired': '請先完成安全驗證，再要求登入連結。',
    'settings.account.feedback.magicLinkCooldown': '請等待一分鐘後再要求新的登入連結。',
    'settings.account.feedback.magicLinkError': 'Edenia 無法傳送登入連結，請再試一次。',
    ...
    'settings.account.feedback.linkSent': '請前往你的電子郵件查收安全登入連結。',
