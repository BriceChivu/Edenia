...
export const ZH_HANS_LOCALIZED = {
  ...
  'settings.scoring.exampleAnki': '复习 30 张 Anki 卡会得到 10 分，但复习 29 张会得到 9 分（9.7 向下取整为 9）。',
    ...
    'settings.sync.importWarningTitle': '替换此学习档案？',
    'settings.sync.importWarning': '导入会替换此学习档案。Edenia 不会自动合并进度。Edenia 会先保护当前版本，以便导入失败时自动恢复。',
    'settings.sync.importFile': '已选择文件：{fileName}',
    'settings.sync.importCancel': '取消',
    'settings.sync.importConfirm': '保护当前进度并替换',
    ...
    'profileAccess.resolving.title': '正在打开你的学习进度…',
    ...
    'profileAccess.authentication.title': '登录以解锁你的学习档案',
    'profileAccess.authentication.body': '请使用拥有此学习档案的账户。',
    'profileAccess.authentication.back': '返回锁定提示',
    'profileAccess.authentication.status': '在所有权验证成功前，你的学习档案将保持隐藏。',
    ...
    'profileConflict.protectedAvailableToast': '受保护的版本可下载至 {date}。',
    'profileConflict.protectedDownloadStarted': '已开始下载受保护的版本。',
    'profileConflict.viewInSettings': '在设置中查看',
  ...
  'profileAccess.recovering.title': '我们需要检查你的学习进度',
    'profileAccess.recovering.body': 'Edenia 还不能打开你的学习进度。你保存的副本是安全的。请重试或退出登录。',
    'profileAccess.recovering.continue': '重试',
    'profileAccess.missingHead.title': '选择恢复副本',
    'profileAccess.missingHead.body': 'Edenia 找到了以往进度，但没有找到当前云端进度快照。请恢复或导出下方的可信副本。',
    'profileAccess.unusableHead.title': '选择恢复副本',
    'profileAccess.unusableHead.body': 'Edenia 无法安全读取当前云端进度快照。请恢复或导出下方的可信副本。',
    'profileAccess.recovery.title': '可用的恢复副本',
    'profileAccess.recovery.local': '此设备中有一个已验证属于当前登录账号的学习者档案。',
    'profileAccess.recovery.protected': '有一个受保护的云端进度快照可用至 {date}。',
    'profileAccess.recovery.restore': '恢复此副本',
    'profileAccess.recovery.export': '导出此副本',
    'profileAccess.recovery.none': '暂时没有可信的恢复副本。请重试或退出登录。',
    'profileAccess.recovery.restoreFailed': 'Edenia 无法恢复该副本。没有替换任何内容，恢复副本仍可使用。',
    ...
    'accountlessProfileMigration.notice.title': '在所有设备上保护你的城镇',
    'accountlessProfileMigration.notice.body': '将这座城镇备份到你的 Edenia 账号，以保护进度并在其他设备上继续使用。',
    'accountlessProfileMigration.notice.status': '还有 {days} 天必须登录。',
    'accountlessProfileMigration.countdown.title': '{days} 天后必须登录',
    'accountlessProfileMigration.countdown.titleSingular': '1 天后必须登录',
    'accountlessProfileMigration.countdown.titleNow': '现在必须登录',
    'accountlessProfileMigration.countdown.body': '立即备份这座城镇，以保护进度并在所有设备上使用。',
    'accountlessProfileMigration.countdown.status': '宽限期内，你仍可在此浏览器中使用这座城镇。',
    'accountlessProfileMigration.finalGate.title': '欢迎回来，你的城镇还在这里。',
    'accountlessProfileMigration.finalGate.body': '请先登录并保护这座城镇，Edenia 才会开放学习。',
    'accountlessProfileMigration.finalGate.status': '身份验证和学习档案所有权检查成功前，此浏览器中的副本不会改变。',
    'accountlessProfileMigration.authentication.title': '登录或创建账号',
    'accountlessProfileMigration.authentication.body': '登录后，Edenia 只会在确认该账号没有云端进度时关联这座城镇。',
    'accountlessProfileMigration.authentication.status': '备份成功前，此浏览器中的副本不会改变。',
    'accountlessProfileMigration.confirmation.title': '以 {email} 继续？',
    'accountlessProfileMigration.confirmation.body': '请先确认此邮箱，Edenia 才会检查该账号能否安全接收这座城镇。',
    'accountlessProfileMigration.confirmation.status': '尚未关联或上传任何内容。',
    'accountlessProfileMigration.attaching.title': '正在备份你的城镇…',
    'accountlessProfileMigration.attaching.body': 'Edenia 正在验证账号，并接受第一个受保护的云端修订版本。',
    'accountlessProfileMigration.attaching.status': '请保持此页面打开。浏览器中的原始副本仍受到保护。',
    'accountlessProfileMigration.backupFailed.title': '尚未备份',
    'accountlessProfileMigration.backupFailed.body': '你可以继续在此设备上学习。原始城镇在这里受到保护，但备份成功前无法在其他设备上使用。',
    'accountlessProfileMigration.backupFailed.status': '未删除任何旧浏览器副本。',
    'accountlessProfileMigration.signedInProfilePresent.title': '此已登录的学习档案已有进度',
    'accountlessProfileMigration.signedInProfilePresent.body': 'Edenia 没有关联或替换任何城镇。你可以改用另一个没有已保存进度的登录账号，或稍后再试。',
    'accountlessProfileMigration.signedInProfilePresent.status': '此浏览器中的城镇未发生变化。',
    'accountlessProfileMigration.action.backup': '立即备份我的进度',
    'accountlessProfileMigration.action.confirm': '以此邮箱继续',
    'accountlessProfileMigration.action.openSignIn': '打开登录',
    'accountlessProfileMigration.action.retry': '重新备份',
    'accountlessProfileMigration.action.later': '稍后',
    ...
    'settings.startOver.open': '重新开始',
    'settings.startOver.warning': '要使用空白学习档案重新开始吗？你的语言、频道、学习记录、连续天数、小镇进度和设置会在所有设备上重置。这不会删除你的 Edenia 帐户，也不会将你退出登录。你可以在 30 天内撤销。',
    'settings.startOver.cancel': '取消',
    'settings.startOver.confirm': '重新开始',
    'settings.startOver.undoTitle': '已重新开始',
    'settings.startOver.undoAvailableUntil': '你之前的进度会保护到 {date}。',
    'settings.startOver.undo': '撤销重新开始',
  ...
  'toast.importOwnerRequired': '登录后的学习档案加载完成后才能导入。',
  'toast.importProtectionRequired': 'Edenia 无法保护你当前的进度。没有任何更改。请重试或导出当前进度。',
  'toast.importStaleRevision': '导入前云端进度已发生变化。没有替换任何内容。请重试或导出当前进度。',
  'toast.importRolledBack': '导入未能完成，Edenia 已恢复你当前的进度。请重试或将其导出。',
