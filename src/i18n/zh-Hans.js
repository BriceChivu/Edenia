...
export const ZH_HANS_LOCALIZED = {
    ...
    'onboarding.account.title': '最后一步',
    'onboarding.account.subtitle': '注册即可获得更个性化的 Edenia 体验。完全免费！',
    ...
    'settings.account.signedOutTitle': '登录 Edenia',
    'settings.account.signedOutBody': '使用 Google 可快速登录，也可以通过电子邮箱获取安全登录链接。',
    ...
    'settings.account.sendLink': '向我发送登录链接',
    'settings.account.sendingLink': '正在发送链接…',
    ...
    'settings.account.feedback.captchaRequired': '请先完成安全验证，再请求登录链接。',
    'settings.account.feedback.magicLinkCooldown': '请等待一分钟后再请求新的登录链接。',
    ...
    'settings.account.feedback.linkSent': '请前往你的电子邮箱查收安全登录链接。',
