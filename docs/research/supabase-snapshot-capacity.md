...
9. **Monitor before Supabase enforces limits.** Recommended project policy—not an official Supabase limit—is a warning at 300 MB total database size and a stop/review gate at 350 MB; for egress, warn at 3 GB and review at 3.5 GB. Public enrollment must stop or upgrade before continued growth risks read-only/402 restrictions.
